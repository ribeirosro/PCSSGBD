...
public class ExtratoVisual extends javax.swing.JFrame {

    ExtratoControle control = new ExtratoControle();
    
    public ExtratoVisual() {
        initComponents();
        
        control.mostrarExtrato(jList1);
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(586, 532));

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));
        jPanel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel4.setPreferredSize(new java.awt.Dimension(544, 490));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel3, 581, 581, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExtratoVisual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExtratoVisual().setVisible(true);
            }
        });
    }
